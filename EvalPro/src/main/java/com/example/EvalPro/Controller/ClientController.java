...
public class ClientController {
    ...
    public String submitRevaluation(
        ...
        try {
            ...
            sendEmailConfirmation(email, fName, seatNumber, subjectsString);
    ...
    private void sendEmailConfirmation(String to, String studentName, String seatNumber, String subjects) {

        String from = "ad.developer@gmail.com";
        String subject = "Revaluation Request Submitted Successfully";

        String content = "<h2>Revaluation Request Confirmation</h2>"
                + "<p>Dear <strong>" + studentName + "</strong>,</p>"
                + "<p>Your revaluation request has been successfully submitted.</p>"
                + "<p><strong>Student ID:</strong> " + seatNumber + "</p>"
                + "<p><strong>Subjects for Revaluation:</strong> " + subjects + "</p>"
                + "<p>We will notify you once the evaluation process is completed.</p>"
                + "<p>For any queries, contact support at <a href='mailto:ad.developer@gmail.com'>ad.developer@gmail.com</a>.</p>"
                + "<p>Thank you,</p>"
                + "<p>The Examination Department</p>";

        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);

            helper.setFrom(from, "EvalPro");
            helper.setTo(to);
